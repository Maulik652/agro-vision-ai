...
CROP_PROFILES: Dict[str, Dict[str, float]] = {
    "Tomato": {
        ...
        "opt_rainfall": 95.0,
        "opt_humidity": 68.0,
        "opt_soil_moisture": 58.0,
        "yield_baseline_tpha": 4.2,
        "yield_min_tpha": 2.5,
        "yield_max_tpha": 8.5,
        "heat_tolerance": 0.62,
        "rain_tolerance": 0.58,
        ...
        "cost_seed_per_hectare": 12000.0,
        "cost_fertilizer_per_hectare": 20500.0,
        "cost_labor_per_hectare": 24750.0,
        "cost_irrigation_per_hectare": 11750.0,
        "production_cost_per_hectare": 69000.0,
        "irrigation_mm": 30.0
    },
    "Rice": {
        "opt_temp": 30.0,
        "opt_rainfall": 140.0,
        "opt_humidity": 78.0,
        "opt_soil_moisture": 74.0,
        "yield_baseline_tpha": 5.1,
        "yield_min_tpha": 3.5,
        "yield_max_tpha": 7.8,
        "heat_tolerance": 0.78,
        "rain_tolerance": 0.85,
        "pest_sensitivity": 1.0,
        "market_base_price": 2400.0,
        "cost_seed_per_hectare": 9000.0,
        "cost_fertilizer_per_hectare": 18000.0,
        "cost_labor_per_hectare": 23000.0,
        "cost_irrigation_per_hectare": 11000.0,
        "production_cost_per_hectare": 61000.0,
        "irrigation_mm": 36.0
    },
    "Wheat": {
        "opt_temp": 23.0,
        "opt_rainfall": 78.0,
        "opt_humidity": 55.0,
        "opt_soil_moisture": 48.0,
        "yield_baseline_tpha": 3.6,
        "yield_min_tpha": 2.4,
        "yield_max_tpha": 6.2,
        "heat_tolerance": 0.55,
        "rain_tolerance": 0.52,
        "pest_sensitivity": 0.88,
        "market_base_price": 2550.0,
        "cost_seed_per_hectare": 6800.0,
        "cost_fertilizer_per_hectare": 14200.0,
        "cost_labor_per_hectare": 17400.0,
        "cost_irrigation_per_hectare": 8600.0,
        "production_cost_per_hectare": 47000.0,
        "irrigation_mm": 26.0
    },
    "Cotton": {
        "opt_temp": 29.0,
        "opt_rainfall": 92.0,
        "opt_humidity": 62.0,
        "opt_soil_moisture": 52.0,
        "yield_baseline_tpha": 2.8,
        "yield_min_tpha": 1.7,
        "yield_max_tpha": 4.2,
        "heat_tolerance": 0.84,
        "rain_tolerance": 0.6,
        "pest_sensitivity": 1.15,
        "market_base_price": 6800.0,
        "cost_seed_per_hectare": 9800.0,
        "cost_fertilizer_per_hectare": 16500.0,
        "cost_labor_per_hectare": 20400.0,
        "cost_irrigation_per_hectare": 9300.0,
        "production_cost_per_hectare": 56000.0,
        "irrigation_mm": 28.0
    },
    "Maize": {
        "opt_temp": 26.0,
        "opt_rainfall": 86.0,
        "opt_humidity": 60.0,
        "opt_soil_moisture": 51.0,
        "yield_baseline_tpha": 4.0,
        "yield_min_tpha": 2.8,
        "yield_max_tpha": 7.2,
        "heat_tolerance": 0.72,
        "rain_tolerance": 0.64,
        "pest_sensitivity": 1.05,
        "market_base_price": 2050.0,
        "cost_seed_per_hectare": 6200.0,
        "cost_fertilizer_per_hectare": 12800.0,
        "cost_labor_per_hectare": 15700.0,
        "cost_irrigation_per_hectare": 8300.0,
        "production_cost_per_hectare": 43000.0,
        "irrigation_mm": 24.0
    },
    "Soybean": {
        "opt_temp": 25.0,
        "opt_rainfall": 88.0,
        "opt_humidity": 64.0,
        "opt_soil_moisture": 54.0,
        "yield_baseline_tpha": 3.1,
        "yield_min_tpha": 1.8,
        "yield_max_tpha": 4.5,
        "heat_tolerance": 0.64,
        "rain_tolerance": 0.66,
        "pest_sensitivity": 0.92,
        "market_base_price": 4500.0,
        "cost_seed_per_hectare": 5600.0,
        "cost_fertilizer_per_hectare": 11800.0,
        "cost_labor_per_hectare": 14200.0,
        "cost_irrigation_per_hectare": 7400.0,
        "production_cost_per_hectare": 39000.0,
        "irrigation_mm": 21.0
    },
    "Groundnut": {
        "opt_temp": 28.0,
        "opt_rainfall": 82.0,
        "opt_humidity": 58.0,
        "opt_soil_moisture": 49.0,
        "yield_baseline_tpha": 2.6,
        "yield_min_tpha": 1.6,
        "yield_max_tpha": 4.0,
        "heat_tolerance": 0.68,
        "rain_tolerance": 0.55,
        "pest_sensitivity": 0.9,
        "market_base_price": 5400.0,
        "cost_seed_per_hectare": 6100.0,
        "cost_fertilizer_per_hectare": 12100.0,
        "cost_labor_per_hectare": 14900.0,
        "cost_irrigation_per_hectare": 7900.0,
        "production_cost_per_hectare": 41000.0,
        "irrigation_mm": 22.0
    }
}
...
def growth_curve_by_crop(crop_name: str, final_yield: float) -> List[float]:
    stage_profiles: Dict[str, List[float]] = {
        ...
        "Maize": [0.16, 0.33, 0.55, 0.75, 0.9, 1.0],
        "Soybean": [0.15, 0.3, 0.53, 0.73, 0.89, 1.0],
        "Groundnut": [0.13, 0.29, 0.5, 0.71, 0.88, 1.0]
    }
